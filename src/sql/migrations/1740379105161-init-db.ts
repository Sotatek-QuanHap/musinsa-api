...
export class InitDb1740379105161 implements MigrationInterface {
    name = 'InitDb1740379105161'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "products" ("productId" character varying(255) NOT NULL, "platform" character varying(255) NOT NULL, "sku" character varying(255), "productName" character varying(255), "url" character varying(1024), "categoryId" character varying(255), "categoryName" character varying(255), "brandName" character varying(255), "sellerName" character varying(255), "normalPrice" numeric(10,2), "salePrice" numeric(10,2), "finalPrice" numeric(10,2), "coupon" numeric(10,2), "reviewCount" integer, "stock" integer, "saleInfo" character varying(1024), "extraInfo" json, "extraImages" jsonb NOT NULL DEFAULT '[]', "options" jsonb NOT NULL DEFAULT '[]', "image" character varying(1024), "soldOut" boolean NOT NULL DEFAULT false, "raw" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_defe7457134183937a660116b92" PRIMARY KEY ("productId", "platform"))`);
        await queryRunner.query(`CREATE INDEX "idx_category" ON "products" ("categoryId") `);
        await queryRunner.query(`CREATE TABLE "product_histories" ("id" SERIAL NOT NULL, "productId" character varying(255) NOT NULL, "platform" character varying(255) NOT NULL, "normalPrice" numeric(10,2), "salePrice" numeric(10,2), "finalPrice" numeric(10,2), "stock" integer, "coupon" numeric(10,2), "reviewCount" integer, "recordedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_044c5e6c6e913fcc761b2bfc914" PRIMARY KEY ("id"))`);
